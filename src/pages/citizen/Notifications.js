            ...
            <div className="card mt-8">
                <div className="p-6 pt-8">
                    {notifications.length > 0 ? (
                        <button className="btn-outline text-sm px-4 py-2" type="button" onClick={handleMarkAll} disabled={busyId === "all"}>
                            ...
                            {notifications.map((notif) => (
                                <div key={notif.id} className="flex gap-4 p-4 bg-gray-50 rounded-xl">
                                    ...
                                    <div>
                                        ...
                                        {!notif.read ? (
                                            <button className="btn-outline text-sm px-4 py-2 mt-3" type="button" onClick={() => handleMarkRead(notif.id)} disabled={busyId === notif.id}>
