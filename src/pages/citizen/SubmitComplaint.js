...
function SubmitComplaint() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // This is the correct place to log the response for debugging
            ...
            <article className="citizen-v2-card submit-card">
                <div className="p-6">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-6">
                            <label className="block text-sm font-medium mb-2">Attach Photo</label>
                            <input
                            ...
                            />
                            {previewUrl && <img src={previewUrl} alt="Preview" className="max-h-48 mt-4 rounded" />}
                            {selectedFile && (
                                <button type="button" onClick={clearFile} className="mt-2 text-blue-600 underline block">
                                    Remove file
                                </button>
                            )}
                        </div>
